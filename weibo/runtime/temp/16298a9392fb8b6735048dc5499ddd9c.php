<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"E:\web\miaosha\public/../application/admin\view\auth_group\add.html";i:1545842676;s:55:"E:\web\miaosha\application\admin\view\public\_meta.html";i:1543753456;s:57:"E:\web\miaosha\application\admin\view\public\_footer.html";i:1542119684;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
                    ...
                    <dd>
                        ...
                        <dl class="cl permission-list2">
                            <dt style="margin-right: 10px;">
                                <label class="" >
                                    <input type="checkbox"    class="isChecked"   id="user-Character-0-<?php echo $two['id']; ?>">
                            ...
                            <dd>
                                ...
                                <label class="">
                                    <input type="checkbox" value="<?php echo $three['id']; ?>" name="rules[]" id="user-Character-0-0-<?php echo $three['id']; ?>" class="isChecked">
    ...
    $(function(){
        ...
        $("#form-admin-role-add").validate({
            ...
            submitHandler:function(form){
                $(form).ajaxSubmit({
                    type: 'post',
                    url: "<?php echo url('AuthGroup/add'); ?>" ,
