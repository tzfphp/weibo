<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:64:"E:\web\miaosha\public/../application/admin\view\index\index.html";i:1545877560;s:55:"E:\web\miaosha\application\admin\view\public\_meta.html";i:1543753456;s:57:"E:\web\miaosha\application\admin\view\public\_header.html";i:1545841896;s:55:"E:\web\miaosha\application\admin\view\public\_menu.html";i:1545928384;s:57:"E:\web\miaosha\application\admin\view\public\_footer.html";i:1542119684;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml">秒杀后台管理系统</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="<?php echo url('Index/index'); ?>">H-ui</a> <span class="logo navbar-slogan f-l mr-10 hidden-xs">v1.0</span> <a aria-hidden="false" class="nav-toggle Hui-iconfont visible-xs" href="javascript:;">&#xe667;</a>
			...
			<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
				<ul class="cl">
					<li class="dropDown dropDown_hover"> <a href="#" class="dropDown_A">
						<img  src="<?php echo $img; ?>" class="avatar radius size-M">

						<i class="Hui-iconfont">&#xe6d5;</i></a>
						<ul class="dropDown-menu menu radius box-shadow menu_dropdown bk_2">
							<li><a data-href="<?php echo url('Person/index'); ?>" onclick="Hui_admin_tab(this)" data-title="个人中心" href="javascript:void(0)">个人中心</a></li>
							<li><a href="<?php echo url('Index/loginOut'); ?>">退出</a></li>
						</ul>
					<li style="font-size: medium"> <?php echo $admin; ?> </li>
					<li> &nbsp;&nbsp;&nbsp;</li>
					</li>
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-product">
			<dt><i class="Hui-iconfont">&#xe620;</i> 秒杀管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>

					<li><a data-href="<?php echo url('Active/index'); ?>" data-title="活动管理" href="javascript:void(0)">活动管理</a></li>
					<li><a data-href="<?php echo url('Order/index'); ?>" data-title="订单管理" href="javascript:void(0)"> 订单管理</a></li>
					<li><a data-href="<?php echo url('Goods/index'); ?>" data-title="商品管理" href="javascript:void(0)"> 商品管理</a></li>
					<li><a data-href="<?php echo url('Question/index'); ?>" data-title="问答管理" href="javascript:void(0)"> 问答管理</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-comments">
		...
		<dl id="menu-admin">
			...
			<dd>
				<ul>
					<li><a data-href="<?php echo url('AuthGroup/index'); ?>" data-title="角色管理" href="javascript:void(0)">角色管理</a></li>
					<li><a data-href="<?php echo url('AuthRule/index'); ?>" data-title="权限管理" href="javascript:void(0)">权限管理</a></li>
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="http://www.miaosha.tzf/static/hui/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
